...
export const questionsAPI = {
  ...
  createQuestion: async (
    ...
    const response = await api.post<SingleQuestionResponse>(
      "/questions",
      questionData
    );
    return response.data;
  ...
  updateQuestion: async (
    ...
    const response = await api.put<SingleQuestionResponse>(
      `/questions/${id}`,
      questionData
    );
    return response.data;
  ...
  generateQuestions: async (
    ...
    const response = await api.post<GeneratedQuestionsResponse>(
      "/questions/generate",
      request
    );
    return response.data.questions;
...
export const attemptsAPI = {
  submitAttempt: async (
    ...
    const response = await api.post<SingleAttemptResponse>(
      "/attempts",
      attemptData
    );
    return response.data;
